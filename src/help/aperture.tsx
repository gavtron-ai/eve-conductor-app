  ...
  intro: [
    {
      ...
      body: (
        <>
          <Limit>
            <b>We are reworking how this app talks to Aperture.</b> Aperture&apos;s developer told us that the way the app read the map cost their server thousands of requests a day per user. That code has been <b>removed</b> (0.215.0), and a proper data path is being worked out with them. Until that is solved properly, the <b>Σ Summary</b>, the Home <b>chain dashlets</b> and the Theft Conductor&apos;s <b>refresh from Aperture</b> are unavailable and show a blocker; the pages below describe them as they worked and will be rewritten when they return. What is left is an ordinary browser tab: the map loads only while the Corp Map tab is on screen and the window is in sight (it is unloaded two minutes after the window is minimised or hidden). To give the raid alert its map, copy your system list here and use <b>📋 import map from clipboard</b> in the Theft Conductor.
          </Limit>
          <p>
