          ...
          <table className="data">
            <thead>
              <tr>
                ...
                <th className="sortable" onClick={() => clickHeader('sell')}><Tip tip="Expected sale price per unit at this station — a LISTING, not a trade: in 'instant' the standing buy orders you would sell into, in 'order' the lowest current sell listing you would match. Quantities are capped by what the region actually traded per day (ESI history).">Sell @</Tip>{indicator('sell')}</th>
